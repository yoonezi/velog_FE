...
export default function PendingPosts() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8080/api/post/pending/posts?page=0&size=10`, {
        page: 0,
        size: 10,
        headers: {
        ...
        <Container>
          <Body>
            <UserInfo>
              ...
              <UserProfileBottom></UserProfileBottom>
            </UserInfo>
            ...
            <List
              ...
              renderItem={(item) => (
                <List.Item
                  onClick={() => navigate(`/post/pending/${item.postId}`)}
